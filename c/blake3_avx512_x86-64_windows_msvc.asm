...
_iroh_blake3_compress_in_place_avx512 PROC
        sub     rsp, 72
...
@@:
        ...
        add     rsp, 72
        ret
_iroh_blake3_compress_in_place_avx512 ENDP
iroh_blake3_compress_in_place_avx512 ENDP

ALIGN 16
iroh_blake3_compress_xof_avx512 PROC
_iroh_blake3_compress_xof_avx512 PROC
        sub     rsp, 72
        vmovdqa xmmword ptr [rsp], xmm6
        vmovdqa xmmword ptr [rsp+10H], xmm7
        vmovdqa xmmword ptr [rsp+20H], xmm8
...
@@:
        ...
        add     rsp, 72
        ret
_iroh_blake3_compress_xof_avx512 ENDP
iroh_blake3_compress_xof_avx512 ENDP
